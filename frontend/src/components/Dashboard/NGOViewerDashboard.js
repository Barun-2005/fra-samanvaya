        ...
        <div className="p-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-card border border-border rounded-xl p-6 mb-8">
                    <h2 className="text-xl font-semibold text-foreground mb-4">Regional Analysis Atlas 🗺️</h2>
                    <p className="text-muted-foreground mb-4">Draw a region on the map to analyze land cover and claim statistics.</p>
                    <AtlasMap />
                </div>
