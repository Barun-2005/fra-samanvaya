          ...
          <div className="w-full max-w-lg space-y-8">
            <div className="rounded-xl bg-input-light dark:bg-input-dark shadow-soft border border-border-light dark:border-border-dark p-8 md:p-12">
              ...
              <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                ...
                <div>
                  <button className="group relative flex w-full justify-center rounded-lg border border-transparent bg-primary py-3 px-4 text-sm font-semibold text-white hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:focus:ring-offset-background-dark" type="submit">
                    Login
                  </button>
                </div>
              </form>
